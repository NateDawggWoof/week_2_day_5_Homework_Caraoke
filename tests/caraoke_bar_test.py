...
class TestCaraokeBar(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._song_1 = Song("YMCA", "The Village People")
        self.caraoke_bar.music_librairy = [self._song_1]
    ...
    #     self.assertEqual(2,self.caraoke_bar.count_songs_in_music_librairy())
